...
<body>
    ...
    <div class="body-inner">
        ...
        <!-- end: Header -->
        <!-- Page title -->
        <section id="page-title" data-bg-parallax="images/clients/cieloazul.jpg">
                ...
                <div class="row team-members team-members-shadow m-b-40">
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <div class="team-desc">
                                <h3>Adrián Delgado</h3>
                                <span>Coofundador</span>
                                <p>Ideólogo de MDLR. Entre sus características destaca su inteligencia, adaptabilidad al cambio, resolutivo y con inmensas ganas de crecer y mejorar </p>
