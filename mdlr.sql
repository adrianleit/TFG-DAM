...
DROP TABLE IF EXISTS `productos_transaccion`;
CREATE TABLE IF NOT EXISTS `productos_transaccion` (
  `id_transaccion` int(15) NOT NULL,
  `id_producto` varchar(50) COLLATE latin1_spanish_ci NOT NULL,
  `cantidad` int(11) NOT NULL,
  `talla` varchar(5) COLLATE latin1_spanish_ci NOT NULL,
  KEY `id_producto` (`id_producto`),
  KEY `id` (`id_transaccion`)
