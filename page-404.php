        ...
        <section class="m-t-80 p-b-150">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text-left">
                            <h1 class="text-medium">Ooops, No hemos podido encontrar la página</h1>
                            <p class="lead">La página que esta buscando puede haber sido borrada, puede haber cambiado su nombre, o estar temporalmente deshabilitada.</p>
